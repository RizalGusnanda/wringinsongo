...
@section('content')
    ...
    <div class="container py-5">
        <p><a href="/wisata" class="link-wisata">Wisata </a> / Destinasi Wisata</p>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-7">
                            <div class="card-body">
                                <h2 class="card-title mb-4 text-center" data-aos="fade-right">{{ $tour->name }}</h2>
                                <p class="detwis-desk mb-3">{!! $tour->description !!}</p>
                                <div class="row">
                ...
                <div class="row justify-content-center mt-4 mb-3" data-aos="fade-up">
                    @if ($tour->history)
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-3 text-center">Sejarah</h4>
                                    <div class="card-title-underline mb-3"></div>
                                    <p class="card-text" style="text-align: justify">{!! $tour->history !!}</p>
                                </div>
                            </div>
                        </div>
                    @endif
